...
return ( <main> <header className="fixed top-0 z-50 w-full border-b border-white/10 bg-[#17150f]/85 text-white backdrop-blur-md"> <div className="container flex h-20 items-center justify-between"> <a href="#inicio" className="serif text-xl tracking-[.18em]">
BRUNA BATISTA <span className="block text-[9px] tracking-[.42em] text-[#c9a66b]">
PSICÓLOGA </span> </a>
    ...
    <div className="container grid gap-14 md:grid-cols-2 md:items-center">
      ...
      <div>
        ...
        <h2 className="text-4xl leading-tight md:text-5xl">
          Olá, eu sou <span className="gold italic">Bruna Batista</span>
        </h2>
    ...
    <div className="container">
      <div className="text-center">
        ...
        <h2 className="mt-4 text-4xl md:text-5xl">
          Áreas de <span className="gold italic">Atuação</span>
        </h2>
      </div>
    ...
    <div className="container grid gap-12 md:grid-cols-2 md:items-center">
      <div>
        ...
        <h2 className="mt-5 text-4xl md:text-5xl">
          Terapia com empatia,
          <br />
          <span className="gold italic">ética e acolhimento</span>
        </h2>
  ...
  <section id="depoimentos" className="bg-white py-24">
    <div className="container text-center">
      ...
      <h2 className="mt-4 text-4xl">
        ...
        <span className="gold italic">confiou</span>
      </h2>

      <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-black/55">
        Espaço reservado para depoimentos reais, inseridos somente com
        autorização.
      </p>
    ...
    <div className="container grid gap-10 md:grid-cols-2 md:items-center">
      <div>
        <h2 className="text-4xl md:text-5xl">
          Vamos cuidar de <span className="gold italic">você?</span>
        </h2>
